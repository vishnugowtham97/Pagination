...
function pagination(persondetails, page, rows) {

var trimStart = (page - 1) * rows
var trimEnd = trimStart + rows

var trimmedData = persondetails.slice(trimStart, trimEnd)

var pages = Math.round(persondetails.length / rows);

return {
'persondetails': trimmedData,
'pages': pages,
}
}
...
var data = pagination(state.persondetails, state.page, state.rows)
var myList = data.persondetails
